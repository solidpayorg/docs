...
_This guide is an early draft and should be considered a work in progress._
...
Layer 2 such as [lightning network](http://lightning.network/) has a deposit in order to participate and two transactions, one to create a channel and another to tear it down.  It can then can scale micro payments across a network efficiently.  
